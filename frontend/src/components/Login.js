    ...
    return (
        <div>
            ...
            <div className='absolute'>
                <img className='w-[100vw] h-[100vh] bg-cover'   alt="banner" />
            </div>
            <form onSubmit={getInputData} className='flex flex-col w-3/12 p-12 my-36 left-0 right-0  mx-auto items-center justify-center absolute rounded-md bg-black opacity-90'>
                ...
                <div className='flex flex-col'>
                    ...
                    <button type='submit' className='bg-blue-500 mt-6 p-3 text-white rounded-sm font-medium'>{`${isLoading ? "loading...":(isLogin?"Login":"Signup")}`}</button>
